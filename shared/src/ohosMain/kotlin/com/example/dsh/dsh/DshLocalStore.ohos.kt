    ...
    private fun writeLegacyProfile(driver: SqlDriver) {
        ...
        execute(driver,
            ...
            listOf(
                ...
                profile.keyId, profile.hostFingerprint, nowMs().toString(),
            ),
        )
